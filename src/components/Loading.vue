<template>
<div>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 742.74 152.94">
  <g id="bubbles">
...
#bubbles{animation-delay: 0s;}
#N{animation-delay: calc(1s / 7 * 1);}
#A1{animation-delay: calc(1s / 7 * 2);}
#A2{animation-delay: calc(1s / 7 * 3);}
#T{animation-delay: calc(1s / 7 * 4);}
#I1{animation-delay: calc(1s / 7 * 5);}
#I2{animation-delay: calc(1s / 7 * 6);}
#V{animation-delay: calc(1s / 7 * 7);}
.cls-1{fill:#00d3e4;}
.cls-2{fill:#0076be;}
.cls-3{fill:#00355f;}
.cls-4{fill:#000000;}
